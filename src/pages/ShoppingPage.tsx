...
const WELCOME = "🛒 Welcome to **ANANTA Shopping Assistant**!\n\nI can help you with:\n🔹 Product comparisons & recommendations\n🔹 Best deals & price analysis\n🔹 Tech specs breakdown\n🔹 Smart purchase decisions\n\nWhat product are you looking for?";

function getShoppingResponse(msg: string): string {
  const lower = msg.toLowerCase();
  if (lower.includes("mouse") || lower.includes("mice")) return `🖱️ **Top Gaming Mice Recommendations:**\n\n1. **Logitech G Pro X Superlight 2** — $159\n   ⭐ 4.8/5 | Ultra lightweight (60g), HERO 2 sensor\n   ✅ Pros: Featherweight, flawless sensor, wireless\n   ❌ Cons: Expensive, no Bluetooth\n\n2. **Razer DeathAdder V3** — $89\n   ⭐ 4.6/5 | Ergonomic shape, Focus Pro sensor\n\n3. **Zowie EC2-CW** — $119\n   ⭐ 4.5/5 | Wireless, plug & play\n\n💡 Want me to compare specific models?`;
  if (lower.includes("laptop") || lower.includes("macbook") || lower.includes("computer")) return `💻 **Best Laptops Right Now:**\n\n1. **MacBook Pro M4 16"** — $2,499\n   ⭐ 4.9/5 | M4 Pro chip, 18hr battery\n\n2. **Framework Laptop 16** — $1,399\n   ⭐ 4.4/5 | Modular, upgradeable\n\n3. **ThinkPad X1 Carbon Gen 12** — $1,699\n   ⭐ 4.6/5 | Ultra-portable, legendary keyboard\n\n💡 What's your budget and primary use?`;
  if (lower.includes("phone") || lower.includes("iphone") || lower.includes("samsung")) return `📱 **Top Smartphones 2026:**\n\n1. **iPhone 16 Pro Max** — $1,199 ⭐ 4.8/5\n2. **Samsung Galaxy S25 Ultra** — $1,299 ⭐ 4.7/5\n3. **Google Pixel 9 Pro** — $999 ⭐ 4.6/5\n\n💡 Want detailed comparisons?`;
  if (lower.includes("headphone") || lower.includes("earbuds") || lower.includes("audio")) return `🎧 **Best Audio Products:**\n\n1. **Sony WH-1000XM6** — $349 ⭐ 4.9/5\n2. **AirPods Pro 3** — $249 ⭐ 4.7/5\n3. **Sennheiser Momentum 4** — $299 ⭐ 4.6/5\n\n💡 Need specific recommendations?`;
  if (lower.includes("hello") || lower.includes("hi")) return `👋 Hello! I'm your **Shopping Assistant**!\n\n🔍 Product Research\n📊 Comparisons\n💰 Budget Picks\n⭐ Reviews\n\nTry asking: *"Best gaming mouse"*, *"Compare laptops"*, or *"Budget headphones"*`;
