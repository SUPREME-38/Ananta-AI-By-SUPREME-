...
CREATE TABLE public.chat_history (
  ...
  module TEXT NOT NULL CHECK (module IN ('chat', 'shopping', 'gaming', 'skills')),
...
CREATE INDEX idx_chat_history_user_module ON public.chat_history (user_id, module, created_at);
